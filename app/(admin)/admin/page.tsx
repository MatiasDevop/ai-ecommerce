...
import { AIInsightsCard, LowStockAlert, RecentOrders, StatCard } from "@/components/admin";
  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button onClick={handleCreateProduct} disabled={isPending} className="w-full sm:w-auto">
          {isPending ? (
